    ...
    <>
      ...
      <AnimatePresence>
        {visible && (
          ...
          >
            <nav
              className="flex items-center border border-edge border-dashed hover:border-accent/60 bg-background/80 shadow-lg shadow-black/[0.08] backdrop-blur-xl max-w-[calc(100vw-2rem)]"
