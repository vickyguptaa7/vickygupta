      ...
      >
        {techStack.map((tech) => (
          <motion.div
            ...
            className="group relative flex items-center gap-1.5 border border-edge border-dashed px-2 py-1 transition-all bg-surface/50 hover:border-accent/60 sm:gap-2 sm:py-1.5"
          >
            <tech.icon
