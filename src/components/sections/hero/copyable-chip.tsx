...
export function CopyableChip({
  ...
  return (
    <motion.span
      ...
      className="group/chip inline-flex items-center gap-1.5 border border-edge border-dashed bg-surface/50 px-2.5 py-1 text-[11px] text-text-secondary transition-colors group sm:text-xs hover:border-accent/60 duration-300"
    >
      <a
        href={href}
