  ...
  return (
    <Panel className="p-0">
      <div className="flex flex-col sm:flex-row items-stretch">
        ...
        <div className="flex">
          <MagneticAvatar />
          <div className="group flex sm:hidden flex-col justify-center flex-1 p-3 border-l border-edge border-dashed ">
            <motion.div
        ...
        <div className="flex flex-col flex-1 min-w-0 border-t sm:border-t-0 sm:border-l border-edge border-dashed">
          {/* Name + Tagline */}
          <div className="hidden sm:flex group flex-col justify-center flex-1 p-3 border-b border-edge border-dashed sm:p-4">
            <motion.div
              initial={{ opacity: 0, x: -10 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{
