        ...
        {projects.map((project, index) => {
          ...
          return (
            <motion.div key={project.id} variants={staggerItem}>
              <SpotlightCard
                className="group/btn relative overflow-hidden font-mono transition-colors  w-full flex flex-col"
                sides={[projects?.length - 1 === index ? "none" : "bottom"]}
              >
                ...
                >
                  ...
                  <div className="relative flex h-7 w-7 shrink-0 items-center justify-center border border-dashed border-edge z-1 transition-colors group-hover/btn:border-accent/40 bg-surface sm:h-8 sm:w-8 group-hover/btn:-rotate-10">
                    {project.icon ? (
                      <Image
                        src={project.icon}
                  ...
                  <div className="pointer-events-none absolute bottom-3 left-[1.625rem] h-screen border-l-[1px] border-dashed border-edge sm:left-8 group-hover/btn:border-accent/40 duration-300 transition-colors" />
                  <div className="pointer-events-none absolute bottom-3 left-[1.625rem] w-2 border-t-[1px] border-dashed border-edge sm:left-8 group-hover/btn:border-accent/40 duration-300 transition-colors" />
