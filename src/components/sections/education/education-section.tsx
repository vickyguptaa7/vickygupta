            ...
            >
              ...
              <div className="flex flex-col gap-1 overflow-hidden relative">
                ...
                <div className="flex w-full items-start gap-1">
                  {/* Graduation icon */}
                  <div className="relative mx-0.5 mt-2.5 flex h-5 w-5 items-center justify-center rounded-sm border border-dashed border-edge p-0.5 text-text-muted transition-colors group-hover:border-accent/20">
                    <LuGraduationCap className="relative z-10 h-4 w-4 bg-background p-0.5" />
                    <div className="absolute top-0 left-1/2 h-screen -translate-x-1/2 border-l-[1px] border-dashed border-edge" />
                  </div>
                  <div className="absolute bottom-0 left-3 w-2 border-t-[1px] border-dashed border-edge" />
