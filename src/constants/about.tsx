export const aboutData = {
  bio: [
    <>
      Hey there, I&apos;m <strong className="font-semibold">Vicky Gupta</strong>
      !
    </>,
    <>
    ...
    <>
      ...
      <strong className="font-semibold">
        {" "}
        pushing platform performance to its limits
      </strong>{" "}
    ...
    <>
      ...
      . I am always learning, always building, and always open to a good
      conversation.
    </>,
